document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: 'Threat Hunting Fundamentals', start: 1, end: 6 },
            { name: 'Threat Hunting Process', start: 7, end: 10 },
            { name: 'Threat Intelligence Fundamentals', start: 11, end: 16 },
            { name: 'Stuxbot: Intel Report', start: 17, end: 20 },
            { name: 'Stuxbot: The Hunt (Part 1)', start: 21, end: 25 },
            { name: 'Stuxbot: The Hunt (Part 2)', start: 26, end: 29 }
        ];
