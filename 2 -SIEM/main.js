document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: 'Introduzione SIEM', start: 1, end: 4 },
            { name: 'Requisiti & Compliance', start: 5, end: 7 },
            { name: 'Elastic Stack', start: 8, end: 13 },
            { name: 'SOC Fundamentals', start: 14, end: 16 },
            { name: 'MITRE ATT&CK', start: 17, end: 18 },
            { name: 'SIEM Use Cases', start: 19, end: 24 },
            { name: 'Alert Triaging', start: 25, end: 28 }
        ];
