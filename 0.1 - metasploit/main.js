document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: '📖 Introduzione & Filosofia', start: 1, end: 5 },
            { name: '🏗️ Architettura & MSF Engagement', start: 6, end: 10 },
            { name: '🧩 Moduli & Selezione', start: 11, end: 15 },
            { name: '📦 Payloads & Meterpreter', start: 16, end: 20 },
            { name: '🗄️ Database, Plugins & Best Practices', start: 21, end: 25 }
        ];
