document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: 'Introduction', start: 1, end: 1 },
            { name: 'Malware Types', start: 2, end: 3 },
            { name: 'Sources & Safety', start: 4, end: 5 },
            { name: 'Methodology', start: 6, end: 7 },
            { name: 'Windows Internals', start: 8, end: 9 },
            { name: 'Windows API', start: 10, end: 11 },
            { name: 'PE Structure', start: 12, end: 13 },
            { name: 'Static Analysis', start: 14, end: 14 },
            { name: 'File Identification', start: 15, end: 16 },
            { name: 'Adv. Hashing', start: 17, end: 19 },
            { name: 'Strings & Obfuscation', start: 20, end: 21 },
            { name: 'Packing (UPX)', start: 22, end: 22 },
            { name: 'Processes & Memory', start: 23, end: 23 },
            { name: 'DLLs & Imports', start: 24, end: 25 },
            { name: 'Dynamic Analysis', start: 26, end: 28 },
            { name: 'Practical Demo', start: 29, end: 29 },
            { name: 'Conclusion', start: 30, end: 30 }
        ];
