document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: 'Introduzione', start: 1, end: 2 },
            { name: 'Esempi Reali', start: 3, end: 5 },
            { name: 'Scenario', start: 6, end: 6 },
            { name: 'Cyber Kill Chain', start: 7, end: 9 },
            { name: 'MITRE ATT&CK', start: 10, end: 12 },
            { name: 'Incident Handling Process', start: 13, end: 21 },
            { name: 'Caso Studio Insight Nexus', start: 22, end: 28 }
        ];
