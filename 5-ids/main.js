document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: 'Introduzione IDS/IPS', start: 1, end: 2 },
            { name: 'Suricata Fondamenti', start: 3, end: 5 },
            { name: 'Configurazione Suricata', start: 6, end: 9 },
            { name: 'Sviluppo Regole Suricata', start: 10, end: 12 },
            { name: 'Esempi Regole', start: 13, end: 16 },
            { name: 'Zeek Fondamenti', start: 17, end: 19 },
            { name: 'Rilevamento con Zeek', start: 20, end: 21 }
        ];
