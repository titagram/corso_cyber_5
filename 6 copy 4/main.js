document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: ' preparazione', start: 1, end: 1 },
            { name: 'ricognizione', start: 2, end: 2 },
            { name: 'scansione', start: 3, end: 3 },
            { name: 'deep dive', start: 4, end: 4 },
            { name: 'accesso', start: 5, end: 5 },
            { name: 'setup', start: 6, end: 6 },
            { name: 'weaponization', start: 7, end: 8 },
            { name: 'exploit', start: 9, end: 9 },
            { name: 'analisi', start: 10, end: 10 },
            { name: 'target', start: 11, end: 11 },
            { name: 'looting', start: 12, end: 12 },
            { name: 'database', start: 13, end: 13 },
            { name: 'crittografia', start: 14, end: 14 },
            { name: 'cracking', start: 15, end: 15 },
            { name: 'escalation', start: 16, end: 16 },
            { name: 'weaponization', start: 17, end: 17 },
            { name: 'injection', start: 18, end: 18 },
            { name: 'pwned', start: 19, end: 19 },
            { name: 'post-exploitation', start: 20, end: 20 },
            { name: 'impatto reale', start: 21, end: 21 }
        ];
