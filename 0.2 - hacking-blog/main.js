document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: '📖 Setup', start: 1, end: 1 },
            { name: '🔍 Ricognizione', start: 2, end: 2 },
            { name: '📋 Enumerazione', start: 3, end: 3 },
            { name: '🎯 Accesso Iniziale', start: 4, end: 4 },
            { name: '💥 Exploiting', start: 5, end: 5 },
            { name: '🔓 Weaponization', start: 6, end: 6 },
            { name: 'Stabilizzazione', start: 7, end: 7 },
            { name: 'Privilege Escalation', start: 8, end: 8 },
            { name: 'Reverse Engineering', start: 9, end: 9 },
            { name: 'Rooting', start: 10, end: 10 }
        ];
