document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: 'Introduzione a Splunk', start: 1, end: 4 },
            { name: 'SPL - Comandi Base', start: 5, end: 8 },
            { name: 'SPL - Comandi Avanzati', start: 9, end: 12 },
            { name: 'Identificare Dati', start: 13, end: 15 },
            { name: 'Splunk Applications', start: 16, end: 17 },
            { name: 'Intrusion Detection - Introduzione', start: 18, end: 21 },
            { name: 'Intrusion Detection - Alerts', start: 22, end: 23 },
            { name: 'Detection Based on TTPs', start: 24, end: 27 },
            { name: 'Detection Based on Analytics', start: 28, end: 28 },
            { name: 'Conclusioni', start: 29, end: 29 }
        ];
